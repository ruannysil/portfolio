    ...
    <>
      <header className="App-header" id="/">
        <nav className="navigation">
          ...
          <div
            className={`menu ${active_menu ? "active" : ""}`}
            onClick={() => setActive_menu(!active_menu)}
          >
      ...
      <section className="home">
        <div className="home-text">
          ...
          <br />
          <h1 className="text">🤜Networking🤛</h1>
          <nav className="navigation-icon">
            <ul className="nav-menu-icon">
              <li>
                <a
                  href="https://github.com/ruannysil"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsGithub />
              ...
              <li>
                <a
                  href="https://www.facebook.com/ruan.silva.5680899"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsFacebook />
              ...
              <li>
                <a
                  href="https://www.instagram.com/sir_ruan_dev/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <BsInstagram />
          ...
          <a href="Curriculo.pdf" download>
            <p className="home-text">Download CV</p>
          </a>
        </div>
