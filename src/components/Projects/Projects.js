  ...
  const imagesGit = [
    {
      ...
      repo_name: "acordion",
      imgScr:
        "https://user-images.githubusercontent.com/84647446/212552072-feca1aaa-fa31-47d5-b7d5-175181486b6f.jpg",
    },
    {
      id: 2,
      ...
      imgScr:
        "https://user-images.githubusercontent.com/84647446/212552074-0f7d696f-6370-486d-bb6c-4511aba14707.jpg",
    },
    {
      id: 3,
      ...
      imgScr:
        "https://user-images.githubusercontent.com/84647446/212552075-68065107-f012-45d9-87c0-3b1a4384734b.jpg",
    },
    {
      id: 4,
      descricao: "devflix #1",
    ...
    },
    {
      ...
      repo_name: "watch",
      imgScr:
        "https://user-images.githubusercontent.com/84647446/212552094-0b087b86-7935-46b3-80c0-f440178f0708.jpg",
    },
    // {
    //   id: 18,
    ...
    <div>
      <section className="main" id="projects">
        <div className="main-text">
          <h2 data-aos="fade-down" className="main-text-h2 knowledge">
            Alguns<span>projetos</span>
          </h2>
          ...
          <p className="main-text-about" data-aos="zoom-out">
            Estes projetos tem como objetivos mostra meu crescimento e
            conhecimento com desenvolvedor front-end JS, projetos bem
            estruturados, focados sempre facilitar a experiência do
            usuário. Sempre visado deixar os projetos responsivos tanto para
            Desktop como para Móbile.
          </p>
        </div>
        <div className="container-box row">
          {resposite &&
            resposite.map((item, key) => (
              <div className="box-info column" data-aos="zoom-in" key={key}>
                <img
                  src={
                    imagesGit.find(
                      (imgRepository) => item?.name === imgRepository.repo_name
                    )?.imgScr || ""
                  }
                  alt="imagens dos projetos"
                />
                <h4>{item.name}</h4>
